    ...
    methods: {
      ...
      sketch(p) {
        ...
        p.draw = () => {
          ...
          p.image(this.img, padding, padding, p.width / 2 - padding * 1.5 + moveX, p.height / 2 - padding + moveY);

          p.rect(padding, padding + p.height / 2 + moveY, p.width / 2 - padding * 1.5 + moveX, p.height / 2 - padding * 2 - moveY, radius, 0, 0, 0);
          p.rect(p.width / 2 + padding / 2 + moveX, padding, p.width / 2 - padding * 1.5 - moveX, p.height / 2 - padding + moveY, 0, 0, radius, 0);
